...
TT_MUL_ASSIGN = "MUL_ASSIGN"
TT_DIV_ASSIGN = "DIV_ASSIGN"
ASSIGNMENT_OPS = (TT_PLUS_ASSIGN, TT_MINUS_ASSIGN, TT_MUL_ASSIGN, TT_DIV_ASSIGN)
...
POSTFIX_UNARY = (TT_PLUS_PLUS, TT_MINUS_MINUS)
